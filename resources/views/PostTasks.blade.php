...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <form action="{{ route('PostTaskController') }}" method="POST">
                @csrf
                <div class="mb-3">
                @error('name')
                ...
                @enderror
                    ...
                    <input type="text" value="{{ old('status') }}" class="form-control" id="status" name="status" placeholder="Enter the status">
                </div>
